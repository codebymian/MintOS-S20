...
# SEC Floating Feature configuration file for Galaxy Note 20 (c1q)
...
# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy Note20 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG986N
