...
# SEC Floating Feature configuration file for Galaxy S20 (x1q)
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG981N
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 2.77 A / 10 v; 4.55 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_x1q_sm8250
