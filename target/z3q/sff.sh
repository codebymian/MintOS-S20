...
# SEC Floating Feature configuration file for Galaxy S20 Ultra (z3q)
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=>face,pos:0.5:0.0213,size:0.0777:0.0359,type:circle
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_SUBDISPLAY_POLICY=
SEC_FLOATING_FEATURE_LCD_SUPPORT_EXTRA_BRIGHTNESS=false

# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S20 ultra 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG988N
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 2.77 A / 10 v; 4.55 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_z3q_sm8250
