...
find "./out/target/r8q/system" -type f \( -name "services.odex" -o -name "services.vdex" -o -name "framework.odex" -o -name "framework.vdex" -o -name "SecSettings.odex" -o -name "SecSettings.vdex" \) -delete 2>/dev/null
